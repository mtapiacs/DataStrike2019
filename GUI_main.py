    ...
    for o in game_objects_import:
        ...
        if item == "QU":
            display_objects.append(
                [translate_location(o.get_location()), ss.get_image(4, 387, 25, 25, bg_color)])
        elif item == "TR":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(163, 387, 25, 25, bg_color)])
        elif item == "BB":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(99, 133, 25, 25, (0, 0, 255))])
        elif item == "BS":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(35, 227, 25, 25, (0, 0, 255))])
        elif item == "BW":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(227, 196, 25, 25, (0, 0, 255))])
        elif item == "BM":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(69, 322, 25, 25, (0, 0, 255))])
        elif item == "RB":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(99, 133, 25, 25, (255, 0, 0))])
        elif item == "RS":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(35, 227, 25, 25, (255, 0, 0))])
        elif item == "RW":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(227, 196, 25, 25, (255, 0, 0))])
        elif item == "RM":
            display_objects.append([translate_location(
                o.get_location()), ss.get_image(69, 322, 25, 25, (255, 0, 0))])
